...
class Trajectory:
    ...
    def __init__(self,trajectory=None,replicates=None,topology=None,residues=None, slice_option=0):
        ...
        cpptrajhbond : str
            the path to a outfile from AMBER22's Hbond function
        ...
        self.topology=md.load_topology(topology) if topology is not None else None
    ...
    def load_trajectory(self,trajectory=None,topology=None):
        ...
        if not topology:
            ...
            except md.exceptions.TrajError:
